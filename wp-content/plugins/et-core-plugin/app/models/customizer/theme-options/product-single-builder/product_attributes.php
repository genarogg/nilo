...
//		),
        ...
        'attributes_after_description' => array(
            ...
            'tooltip' => sprintf(esc_html__( 'Enable this option to display the product attributes (e.g. color, size, material) after the product short description in %1s.', 'xstore-core' ), '<span class="et_edit" data-parent="shop-quick-view" data-section="quick_view" style="text-decoration: underline;">' . esc_html__('quick view', 'xstore') . '</span>'),
            'section'     => 'product_attributes',
            'default'     => 0,
        ),
